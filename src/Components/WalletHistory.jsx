...
const WalletHistory = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#ffefba] to-[#ffffff] p-4 sm:p-6 text-black">
      ...
      <div className="bg-white rounded-2xl shadow-md p-4 sm:p-6 text-black">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-3">
          <h3 className="text-lg sm:text-xl font-bold flex items-center gap-2 text-black">
            <span className="text-2xl">💰</span> Wallet History
          </h3>
          <img
            src={fastagImage}
            alt="Bharat Connect"
        ...
        <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-end gap-4 mb-6 text-black">
          <div className="flex flex-col w-full sm:w-auto">
            <label className="text-sm font-medium mb-1">From Date</label>
            <input
              type="date"
              className="border border-gray-300 rounded-lg px-3 py-2 w-full sm:w-56 focus:outline-none focus:ring-2 focus:ring-cyan-400 bg-white text-black"
            />
          </div>
          <div className="flex flex-col w-full sm:w-auto">
